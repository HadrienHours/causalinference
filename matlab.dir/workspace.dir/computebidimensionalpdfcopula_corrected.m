function [ea,eb,pdf,pdfc,Xp,Yp] = computebidimensionalpdfcopula_corrected(pathds,N,minx,maxx,dim1,dim2)
...
set(gca,'fontsize',16)
%Compute marginals
[pdf_rtt] = ksdensity(rtt,x_rtt,'function','pdf');
[pdf_tput] = ksdensity(rtt,x_tput,'function','pdf');
...
[Xp,Yp] = meshgrid(pdf_rtt,pdf_tput);
