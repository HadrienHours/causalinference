...
% machine algorithm
%ALPHA_MAX               = 1e8;%value taken in relvm_r in spider toolkit
%MIN_DELTA_LOGALPHA      = 1e-3;% value taken in relvm_r
...
function g = kpc_param(X,alpha,alpha_m,alpha_conv,shuff,flag_cholesky)
           ...
           while (sp>0)
               ...
               for j=1:size(combs,1)
                   ...
                   try
                       ...
                       fprintf('Relevant vector machine failed, multiple ridge regression tried instead\n');
%                     a = svr();
                       a = multi_rr();
