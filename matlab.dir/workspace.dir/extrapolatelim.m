function [X,Y,Zlin,Zcub,Zv4,Znr,Zlinflatten,Zcubflatten,Zv4flatten,Znrflatten] = extrapolatelim(dataset,N,labs,lims)
...
y=dataset(:,2);
z=dataset(:,3);
xlin = linspace(lims(1,1),lims(1,2),N);
ylin = linspace(lims(2,1),lims(2,2),N);
