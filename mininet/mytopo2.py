...
class MyTopo2( Topo ):
    ...
    def __init__( self,k,bw1,delay1,jitter1,loss1,maxqueuesize1,bw2,delay2,jitter2,loss2,maxqueuesize2,**opts):
        ...
        # Initialize topology
	super(MyTopo2,self).__init__(**opts)
	self.k = k
	self.bw1 = bw1
	self.delay1 = delay1
...
topos = { 'mytopo2': ( lambda k=2,bw1=10,delay1='10ms',jitter1=0,loss1=0,maxqueuesize1=1000,bw2=10,delay2='10ms',jitter2=0,loss2=0,maxqueuesize2=1000: MyTopo2(k,bw1,delay1,jitter1,loss1,maxqueuesize1,bw2,delay2,jitter2,loss2,maxqueuesize2))  }
