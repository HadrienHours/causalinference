function [Sta, Cri, p_val, Cri_appr, p_appr] = CInd_test_new_withGP_par(x, y, z, alpha, width,t,tbs,bootstrap)
...
IF_GP = 1;
Approximate = 1;
Bootstrap = bootstrap % Note: set to 0 to save time if you do not use simulation to generate the null !!!
