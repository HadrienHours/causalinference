function [pval stat] = indtest_new_par(X, Y, Z,t,tbs,bootstrap,pars)
...
if isempty(Z) %unconditional HSIC
    ...
    [stat, Cri, p_val_appr, Cri_appr, pval] = CInd_test_new_withGP_par(X, Y, Z, 0.8, pars.width,t,tbs,bootstrap);
end
