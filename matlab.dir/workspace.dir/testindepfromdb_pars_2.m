function [result] = testindepfromdb_pars_2(i,j,k,pathlistindep,alpha)
...
%in the testlist we have x y z1 z2 ... zn S N pval
...
%Zero padding in case Z is not of maximum conditioning set size tested
%offline
