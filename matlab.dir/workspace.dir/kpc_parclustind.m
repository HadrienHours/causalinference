...
function g = kpc_parclustind(X,alpha,alpha_m,alpha_conv,shuff,flag_cholesky)


[qglobs,pglobs]=clust_ind_test(X,alpha,shuff);
...
%                              a = relvm_r(kernel('rbf',rsig));
%                              [tr,b] =
%                              train_par(a,data(X(:,union(st,i)),X(:,pp(k))),alpha_m,alpha_conv);
%                              a = svr();
                             a = multi_rr();
