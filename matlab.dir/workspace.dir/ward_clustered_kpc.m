function [] = ward_clustered_kpc(M,alpha,delta_m,delta_c,shuff,K,outputfile)
...
%Clustering:
IDX = clusterdata(M,'linkage','ward','distance','euclidean','maxclust',K);
...
for k=1:K
    ...
    flag2 = 1;
    alpha1 = alpha - 0.1;
    while flag2 && (alpha1 < 0.3)
        alpha1 = alpha1 + 0.1;
        %flag = 0;
        delta_m1 = delta_m / (1e4);
        %flag2 = 1;
        while flag2 && (delta_m1 < 1e17)
