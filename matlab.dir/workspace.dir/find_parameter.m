function [dsc,dsq,centroids,kopt,bopt,dopt,erroropt,params,err_l] = find_parameter(ds,listk,listb,listd,dimtest,valuetest,dimobj,dimblock,valuetest_l,valuetest_r)
...
%           valuetest_l = lower bound for filtering the values to test
%           prediction
%           valuetest_r = upper bound for fitlering the values to test
%           prediction
%OUTPUT
...
x = [dimtest, valuetest];
[dsc,dsq,params,yval,ymean,err_l,size_l] = test_backdoor_fixed_centroid(ds,dsp,listd,listb, x,dimobj,dimblock,yobj,yrange);
