function [Pmean,Pmedian] = indtestimpl_nloop_pstat_logging_mean_median_index(i,j,k,ds,alpha,S,N,pathdir,indextest)
...
%       indextest: additional index unique for this test
%Output
...
namedir = strcat(namedir,'_nloops_',num2str(N),'_subsize_',num2str(S),'_test_',num2str(indextest),'.dir');
