function [dsp] = random_resampling_noreplacement(ds,N,independent,seed,pos)
% This function takes as input a dataset and output a randomized dataset of
% size N made out ds with picking randomly a sample without replacement. If
...
if N > n
    error('Cannot create a dataset of higher dimension than the input without replacement, see random_resampling function');
end
